...
{
    public static VoxelMeshData CreateMeshData(float[,] noiseMap, int chunkX, int chunkY, int chunkWidth, int chunkHeight, TerrainTable terrainTable, bool edges = true, float edgeThickness = 1f)
    {
    ...
    public static VoxelMeshData CreateMeshData(float[] heightMap, int width, int height, int chunkX, int chunkY, int chunkWidth, int chunkHeight, TerrainTable terrainTable, bool edges = true, float edgeThickness = 1f)
    {
