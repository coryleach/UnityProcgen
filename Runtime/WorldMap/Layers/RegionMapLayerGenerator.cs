...
public class RegionMapLayerGenerator : ScriptableObject
{
  ...
  private static bool TryExpandRegion(RegionData region, int[] regionMap, int width, int height, System.Random rng, List<Vector2Int> neighbors)
  {
  ...
  public static void GetEmptyNeighbors(int[] regionMap, int width, int height, Vector2Int pt, List<Vector2Int> neighbors)
  {
